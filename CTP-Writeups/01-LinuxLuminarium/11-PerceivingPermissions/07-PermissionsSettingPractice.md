# Challenge Name
Modify permissions as asked

## My solve
**Flag:** `pwn.college{4xCIH07VAe_mdKjeSIH5kNlwRc2.QXzETO0wSN3AzNzEzW}`

You can set permissions in direct mode using `=`.
```bash
...
* the world does have write permissions
- the world doesn't have execute permissions
hacker@permissions~permissions-setting-practice:~$ chmod u=-,g=wx,o=w /challenge/pwn 
You set the correct permissions!
Round 5 of 8!
...
- the world doesn't have write permissions
* the world does have execute permissions
hacker@permissions~permissions-setting-practice:~$ chmod u=x,g=x,o=x /challenge/pwn 
You set the correct permissions!
Round 6 of 8!
...
pwn.college{4xCIH07VAe_mdKjeSIH5kNlwRc2.QXzETO0wSN3AzNzEzW}
```

## What I learned
Setting permissions directly
